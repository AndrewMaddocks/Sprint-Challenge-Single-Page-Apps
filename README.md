...
> Answer:
> Benefits are there is no lag when you go from one thing to another because the data is already there. Your internet can turn off and you will still have access to the page because everything was initially loaded. Its faster than server side routing and you just don’t have to worry about that nasty download.
